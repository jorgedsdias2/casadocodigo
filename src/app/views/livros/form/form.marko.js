...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casacodigo$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"coloque o titulo do livro\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" value=\"" +
    marko_escapeXmlAttr(data.livro.preco) +
    "\" placeholder=\"coloque o preco do livro\"></div> <div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\">" +
...
marko_template.meta = {
    id: "/casacodigo$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
